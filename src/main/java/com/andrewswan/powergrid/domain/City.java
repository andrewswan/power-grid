...
public interface City extends Vertex {
    ...
    /**
     * Returns the name by which this city is known to the players, e.g. all
     * three nodes in Paris are called "Paris"
     * 
     ...
     * 
     * @param player can't be <code>null</code> or one of the players returned
     *            by {@link #getConnectedPlayers()}
     * @param step the current step of the game; can't be <code>null</code>
     ...
     * @param step the current step of the game; can't be <code>null</code>
     * @return the cost in elektro of the connected place in this city (i.e.
     *         doesn't include any link costs), or <code>null</code> if the
     *         player can't connect there (e.g. is already connected or there's
