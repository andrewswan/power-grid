...
public interface Plant {
    ...
    public enum PlantType {
        COAL, ECOLOGICAL, // e.g. wind and fusion
        GARBAGE, HYBRID, // burns coal and/or oil
        NUCLEAR, OIL
    }

    /**
     * Adds a unit of the given resource to this plant, e.g. after buying it
     * from the resource market or moving it from another plant
     * 
     * @param resource the resource to add; can't be <code>null</code>
     * @return <code>true</code> if the resource was added (e.g. was of the
     *         right type and there was room for it)
     */
     ...
     * 
     * @return either zero or the plant's maximum capacity (plants can't be run
     *         at below their maximum output)
     */
