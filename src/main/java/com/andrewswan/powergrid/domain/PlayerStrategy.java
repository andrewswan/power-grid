...
public interface PlayerStrategy {
     ...
     * 
     * @return the resources the player wants to buy; can be <code>null</code>
     *         or contain more than the quantities of resources actually
     *         available
     */
     ...
     *         to be connected. Any cities the player can't connect for any
     *         reason will be skipped. The returned array can be
     ...
     * phase). Any such plants that can't actually be operated (e.g. not owned
     * or not enough fuel) will be quietly ignored.
     * 
     * @return the plant numbers of the plants to power; can be
     *         <code>null</code> or an empty array for none
     */
     ...
     * @param plantBeingReplaced the plant being replaced from which resources
     *            may be stripped; will be <code>null</code> if no plant is
     *            being replaced
     */
