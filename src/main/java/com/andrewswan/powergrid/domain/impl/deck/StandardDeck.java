...
public class StandardDeck extends AbstractDeck {
    ...
    private static final Plant[] PLANTS_IN_DECK = {
            ...
            // Oil
            new OilPlant(16, 2, 3), new OilPlant(26, 2, 5),
            new OilPlant(32, 3, 6),
            new OilPlant(35, 1, 5),
            new OilPlant(40, 2, 6),
            // Wind
            new WindPlant(13, 1), new WindPlant(18, 2), new WindPlant(22, 2),
            new WindPlant(27, 3), new WindPlant(33, 4), new WindPlant(37, 4),
            new WindPlant(44, 5) };
