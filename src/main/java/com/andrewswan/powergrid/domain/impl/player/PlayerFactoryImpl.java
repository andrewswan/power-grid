...
public class PlayerFactoryImpl implements PlayerFactory {
  ...
  public Set<Player> getPlayers(final int numberOfPlayers, final Game game) {
    ...
    for (int i = 0; i < numberOfPlayers; i++) {
      ...
      final Colour colour = getColour(i, new ArrayList<Colour>(unusedColours));
   ...
   */
  protected PlayerImpl createPlayer(final int numberOfPlayers, final Game game, final String name,
      final Colour colour, final PlayerStrategy strategy)
  {
   ...
   */
  protected String getName(final int playerNumber, final Collection<String> chosenNames) {
    if (playerNumber < 0) {
   ...
   */
  protected Colour getColour(final int playerNumber, final List<Colour> unusedColours) {
    if (playerNumber < 0) {
      throw new IllegalArgumentException(
          "Invalid player number " + playerNumber);
    }
