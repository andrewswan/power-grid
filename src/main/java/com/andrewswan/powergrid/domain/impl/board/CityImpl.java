...
public class CityImpl extends SparseVertex implements City {
    ...
    static {
        ...
        // An alternative would be to add a Step#getMaxCityConnections method,
        // but
    ...
    /**
     * Constructor for a city with the same internal and display names (always
     * the case except for multi-node cities like Paris)
     * 
    ...
    public CityImpl(final Area area, final String displayName,
        ...
        this.internalName = StringUtils.defaultIfEmpty(internalName,
                displayName);
    }
    ...
    public int connect(final Player player, final Step step) {
        ...
        final int cost = getConnectionCost(player, step); // shouldn't be null
                                                          // here
