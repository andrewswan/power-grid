...
public class CityImpl extends SparseVertex implements City {
   ...
   */
  public CityImpl(Area area, String displayName) {
   ...
   */
  public CityImpl(Area area, String displayName, String internalName) {
  ...
  public int connect(Player player, Step step) {
    ...
    int cost = getConnectionCost(player, step); // shouldn't be null here
  ...
  public boolean isFull(Step step) {
  ...
  public boolean canConnect(Player player, Step step) {
    return !isFull(step) && !isConnected(player);
  }

  public Integer getConnectionCost(Player player, Step step) {
