...
public class StandardResourceMarket extends AbstractResourceMarket {
    ...
    private static final int[] URANIUM_PRICES = { 16, 14, 12, 10, 8, 7, 6, 5,
            4, 3, 2, 1 };
    ...
    static {
        // TODO might be better to push this logic to the superclass (assumes
        // all
        // ResourceMarkets have the same total number of resources)
        STARTING_SPARE_RESOURCES = new ResourcePoolImpl();
        STARTING_SPARE_RESOURCES.addResource(Resource.COAL, TOTAL_COAL
                - STARTING_COAL);
        STARTING_SPARE_RESOURCES.addResource(Resource.OIL, TOTAL_OIL
                - STARTING_OIL);
        STARTING_SPARE_RESOURCES.addResource(Resource.GARBAGE, TOTAL_GARBAGE
                - STARTING_GARBAGE);
        STARTING_SPARE_RESOURCES.addResource(Resource.URANIUM, TOTAL_URANIUM
                - STARTING_URANIUM);
    }
     ...
     * 
     * @param players the number of players in the game; affects the rate at
     *            which resources are restocked
    ...
    public StandardResourceMarket(final int players) {
        super(STARTING_RESOURCES, STARTING_SPARE_RESOURCES,
                getRestockRates(players));
    }
    ...
    protected int getPrice(final Resource resource, final int stock) {
        ...
        return MAXIMUM_NON_URANIUM_PRICE
                - ((stock - 1) / UNITS_PER_PRICE_BRACKET);
    }
}
