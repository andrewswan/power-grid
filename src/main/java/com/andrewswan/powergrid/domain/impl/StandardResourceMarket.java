...
public class StandardResourceMarket extends AbstractResourceMarket {
   ...
   */
  private static Map<Step, ResourcePool> getRestockRates(int players) {
    switch (players) {
      case 2:
   ...
   */
  public StandardResourceMarket(int players) {
    super(
        STARTING_RESOURCES, STARTING_SPARE_RESOURCES, getRestockRates(players));
  }

  @Override
  protected int getPrice(Resource resource, int stock) {
