...
public interface ResourceMarket {
     ...
     *            <code>null</code>
     * @return the cost in elektros (one or more), or <code>null</code> if
    ...
    /**
     * Returns the given resources to the spare pool for this market, for
     * example after a player uses them to power a plant or sells the plant that
     * they were stored in.
     * 
     * @param resources the resources to return; can be <code>null</code> for
     *            none
     */
     ...
     * step of the game (or less if there aren't that many spare resources in
     * the market)
     * 
