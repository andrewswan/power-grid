/*
 * Copyright (c) 2007 Business Information Services. Sydney, Australia. All
 * rights reserved.
 * 
 * This software is the confidential and proprietary information of Business
 * Information Services ("Confidential Information"). You shall not disclose
 * such Confidential Information and shall use it only in accordance with the
 * terms of the license agreement you entered into with Business Information
 * Services.
 */
...
/**
 * <p>
 * Description: runs the Power Grid simulator in text mode
 * </p>
 * 
 * @author andrews
 */
public final class TextRunner {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(TextRunner.class);

    private static final int GAMES_TO_PLAY = 1, PLAYERS = 3;
    ...
    private TextRunner() {
        ...
        try {
            ...
            for (int gameNumber = 1; gameNumber <= GAMES_TO_PLAY; gameNumber++) {
                ...
                final Game game = new StandardGame(new USABoard(PLAYERS),
                        PLAYERS);
