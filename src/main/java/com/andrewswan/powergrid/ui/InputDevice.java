...
public interface InputDevice extends Closeable {
     ...
     */
    Integer bidOnPlant(Colour colour, Plant plant, int minimumBid,
            boolean canPass);
     ...
     * 
     * @param colour the colour being played; can't be <code>null</code>
     * @return the internal names of the cities to connect (case doesn't
     *         matter), in the desired order of connection; can be
    ...
    /**
     * Asks the person playing the given colour which plants they want to
     * operate
     * 
     * @param colour the colour being played; can't be <code>null</code>
     ...
     *            <code>null</code> for none, any <code>null</code> elements are
     *            ignored
     ...
     */
    Integer selectPlantForAuction(Colour colour, Plant[] currentMarket,
            boolean mandatory);
}
