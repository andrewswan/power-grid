...
public class USABoardTest {
     ...
     */
    private void assertAdjacentAreas(final String areaName,
            final int expectedNeighbours) {
     ...
     */
    private void assertLinkCountEquals(final String cityInternalName,
            final int expectedLinkCount) {
        final AbstractBoard board = new USABoard(2);
    ...
    /**
     * Checks that for the given number of players, the given number of areas
     * are in play
     * 
     * @param players
     * @param expectedAreas
     */
    private void assertNumberOfAreasInPlay(final int players,
            final int expectedAreas) {
        // Set up
