...
public class HumanPlayerStrategyTest extends TestCase {
  ...
  public void testGetResourcesToBuy() {
    // Set up
    final ResourcePool mockResources = mocks.createStrictMock(ResourcePool.class);
  ...
  public void testSelectValidPlantToAuction() {
    // Set up
    final Plant mockPlantOne = mocks.createStrictMock(Plant.class);
    expect(mockPlantOne.getNumber()).andStubReturn(PLANT_NUMBER + 1);
    final Plant mockPlantTwo = mocks.createStrictMock(Plant.class);
