...
public class PlayerFactoryImplTest {
    ...
    public void testGetColourOfFirstPlayer() {
        // Invoke
        final Colour colour = factory.getColour(0,
    ...
    public void testGetStrategyOfFirstPlayer() {
        ...
        // Invoke
        final PlayerStrategy strategy = factory.getStrategy(Colour.BLACK,
                mockGame);
    ...
    public void testGetPlayers() {
        ...
        // Invoke
        final List<Player> players = new ArrayList<Player>(factory.getPlayers(
                numberOfPlayers, mockGame));
