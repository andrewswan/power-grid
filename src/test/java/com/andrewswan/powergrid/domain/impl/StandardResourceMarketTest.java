...
public class StandardResourceMarketTest {
    ...
    public void testStartingResources() {
        // Invoke
        market = new StandardResourceMarket(2); // number of players irrelevant
                                                // here
     ...
     * @param expectedCost
     */
    private void assertResourceCost(final ResourcePool resources,
        ...
        // Invoke
        final CostedResourcePool resourcesBought = market.buy(resources,
                Integer.MAX_VALUE);
