...
public class TextInputDeviceTest extends TestCase {
   ...
   * @throws Exception
   */
  private void setUpInputStream(String text) throws Exception {
  ...
  public void testMandatoryBidOnPlant() throws Exception {
    ...
    // Invoke
    Integer bid = inputDevice.bidOnPlant(COLOUR, mockPlant, MINIMUM_BID, false);
  ...
  private void assertCitiesToConnect(
      String inputStream, String[] expectedCities)
    throws Exception
  {
    // Set up
    ...
    // Invoke
    String[] actualCities = inputDevice.getCitiesToConnect(COLOUR);
  ...
  private void assertGetPlantsToOperate(
      String inputStream, int[] expectedPlantNumbers)
    throws Exception
  {
    // Set up
    ...
    // Invoke
    int[] actualPlantNumbers = inputDevice.getPlantsToOperate(COLOUR);
  ...
  public void testBuyOneCoal() throws Exception {
    ResourcePool expectedResources = new ResourcePoolImpl();
  ...
  private void assertGetResourcesToBuy(
      String inputStream, ResourcePool expectedResources)
    throws Exception
  {
    // Set up
    ...
    // Invoke
    ResourcePool actualResources = inputDevice.getResourcesToBuy(COLOUR);
  ...
  public void testSelectNoPlantForAuction() throws Exception {
    // Set up
    Plant[] currentMarket = getMockPlants(PLANT_NUMBER, PLANT_NUMBER + 1);
  ...
  public void testSelectPlantForAuction() throws Exception {
    // Set up
    Plant[] currentMarket = getMockPlants(PLANT_NUMBER);
   ...
   */
  private Plant[] getMockPlants(int... plantNumbers) {
    Plant[] mockPlants = new Plant[plantNumbers.length];
